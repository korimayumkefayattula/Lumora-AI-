...
import { AskLumoraHero } from "../components/dashboard/AskLumoraHero";
import { ContinueLearningCard } from "../components/dashboard/ContinueLearningCard";
import { TodayPlanCard } from "../components/dashboard/TodayPlanCard";
import { QuickStudyTools } from "../components/dashboard/QuickStudyTools";
import { LumoraRecommendationCard } from "../components/dashboard/LumoraRecommendationCard";
import { CompactProgressCard } from "../components/dashboard/CompactProgressCard";
import { WeakAreasCard } from "../components/dashboard/WeakAreasCard";
import { RevisionCenterCard } from "../components/dashboard/RevisionCenterCard";
...
export default function StudentDashboard() {
  ...
  const handleDownloadData = () => {
    ...
    <div className="h-full lumora-crimson-bg bg-[#08080a] text-slate-100 overflow-y-auto font-sans transition-colors duration-300">
      ...
      <header className="px-4 lg:px-8 py-3 flex items-center justify-between sticky top-0 z-20 bg-[#08080a]/85 dark:bg-[#08080a]/85 backdrop-blur-md border-b border-zinc-800/40 transition-colors duration-300">
          ...
          <div className="flex items-center justify-end w-full lg:w-auto gap-2">
            ...
            <button
              ...
              className="w-8 h-8 rounded-xl bg-[#141418] dark:bg-[#141418] border border-zinc-800 dark:border-zinc-800 flex items-center justify-center text-zinc-300 hover:text-rose-400 hover:border-rose-700/60 shadow-xs transition-all"
              title="Refresh Dashboard widgets (Perceived performance loading)"
            >
      ...
      <main className="px-4 sm:px-6 lg:px-8 pb-20 max-w-7xl mx-auto space-y-6">
        ...
        <div className="pt-4 pb-5 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800/80">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/80 text-slate-700 dark:text-slate-300 hover:text-purple-600 dark:hover:text-purple-400 text-xs font-bold transition shadow-xs flex items-center gap-1.5"
            >
        ...
        {isLoading ? (
          ...
          <>
            {/* ========================================================================= */}
            {/* 1. TIER 1 HERO: ASK LUMORA (Flagship AI Workspace Input & Feedback Loop)    */}
            {/* ========================================================================= */}
            <div>
              <AskLumoraHero />
            </div>
            ...
            {/* ========================================================================= */}
            {/* 2 & 3. TIER 1 HERO: CONTINUE LEARNING & TODAY'S PLAN                       */}
            {/* ========================================================================= */}
            ...
            {/* ========================================================================= */}
            {/* 4. TIER 2: QUICK STUDY TOOLS (Compact 8-Pill Grid / 2-col on Mobile)      */}
            {/* ========================================================================= */}
            <div>
              <QuickStudyTools />
            </div>
            ...
            {/* ========================================================================= */}
            {/* 5. TIER 3: PERSONALIZED INTELLIGENCE (Lumora Recommends Revision)         */}
            {/* ========================================================================= */}
            <div>
              <LumoraRecommendationCard />
            </div>

            {/* ========================================================================= */}
            {/* 6 & 7. PROGRESS & REVISION (Compact Progress, Weak Areas & Revision Center)*/}
            {/* ========================================================================= */}
            ...
            <div 
              ...
              className="clay-widget clay-widget-interactive rounded-[16px] p-5 bg-gradient-to-r from-rose-950/50 via-amber-950/40 to-slate-900 border border-rose-800/40 hover:border-rose-500/60 shadow-lg cursor-pointer transition-all duration-300 group flex flex-col md:flex-row md:items-center justify-between gap-4"
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-[14px] bg-gradient-to-br from-rose-600 to-amber-500 text-white flex items-center justify-center shadow-lg shadow-rose-600/30 group-hover:scale-105 transition-transform shrink-0">
            ...
            <div 
              ...
              className="clay-widget clay-widget-interactive rounded-[16px] p-5 bg-gradient-to-r from-blue-950/60 via-indigo-950/50 to-slate-900 border border-blue-800/40 hover:border-blue-500/60 shadow-lg cursor-pointer transition-all duration-300 group flex flex-col md:flex-row md:items-center justify-between gap-4"
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-[14px] bg-gradient-to-br from-blue-600 to-indigo-600 text-white flex items-center justify-center shadow-lg shadow-blue-600/30 group-hover:scale-105 transition-transform shrink-0">
            ...
            {(() => {
              ...
              return (
                <div
                  ...
                  className="clay-widget clay-widget-interactive rounded-[16px] p-5 bg-gradient-to-r from-rose-950/70 via-slate-900 to-indigo-950/70 border border-rose-500/30 hover:border-rose-400/60 shadow-lg hover:shadow-rose-500/10 transition-all cursor-pointer group flex flex-col md:flex-row md:items-center justify-between gap-4"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-[14px] bg-gradient-to-br from-rose-500 to-amber-500 flex items-center justify-center shrink-0 text-white shadow-md shadow-rose-500/20 group-hover:scale-105 transition-transform">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <span className="text-xs font-bold px-3 py-1.5 rounded-[12px] bg-rose-500/20 text-rose-200 border border-rose-500/40 group-hover:bg-rose-500 group-hover:text-white transition-all flex items-center gap-1.5">
            ...
            <div
              ...
              className="clay-widget clay-widget-interactive rounded-[16px] p-5 bg-gradient-to-r from-purple-950/70 via-indigo-950/60 to-slate-900 border border-purple-500/30 hover:border-purple-400/60 shadow-lg hover:shadow-purple-500/10 transition-all cursor-pointer group flex flex-col md:flex-row md:items-center justify-between gap-4"
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-[14px] bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center shrink-0 text-white shadow-md shadow-purple-600/20 group-hover:scale-105 transition-transform">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <span className="text-xs font-bold px-3.5 py-1.5 rounded-[12px] bg-purple-500/20 text-purple-200 border border-purple-500/40 group-hover:bg-purple-600 group-hover:text-white transition-all flex items-center gap-1.5">
            ...
            <div className="clay-widget clay-widget-interactive rounded-[16px] p-5 sm:p-6 bg-gradient-to-r from-rose-950/60 via-slate-900 to-indigo-950/60 border border-rose-900/40 shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative overflow-hidden">
              ...
              <button
                ...
                className="relative z-10 px-5 py-3 rounded-[14px] bg-gradient-to-r from-rose-600 to-indigo-600 hover:from-rose-500 hover:to-indigo-500 text-white font-black text-xs shadow-lg shadow-rose-600/30 flex items-center gap-2 transition active:scale-95 shrink-0"
              >
